...
kfuncs 的 `KF_ACQUIRE`/`KF_RELEASE` 机制与 Map 中的 kptr 功能紧密结合，构成了 eBPF 的内存所有权模型。这部分内容在 [[2026-04-08-ebpf-deep-dive-ch2-5-kptr-and-ownership|第二.五章：kptr 与内存所有权模型]] 中有更详细的讨论，这里我们聚焦于 kfunc 在其中的角色。
