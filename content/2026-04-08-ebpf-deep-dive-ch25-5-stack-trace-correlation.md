...
- **前置依赖**：[[2026-04-08-ebpf-deep-dive-ch25-full-stack-observability|第二十五章]] 中的 TraceID 传播机制
- **技术基础**：[[2026-04-08-ebpf-deep-dive-ch2-maps-and-communication|第二章]] 中的 Map 机制
- **追踪钩子**：[[2026-04-08-ebpf-deep-dive-ch4-tracing-hooks-and-security|第四章]] 中的 kprobe/uprobe 原理
- **用户态追踪**：[[2026-04-08-ebpf-deep-dive-ch7-5-uprobes-dynamic-tracing|第七.五章]] 中的 uprobe 深入
- **延伸阅读**：[[2026-04-08-ebpf-deep-dive-ch8-advanced-tuning-and-profiling|第八章]] 中的性能剖析进阶技巧
