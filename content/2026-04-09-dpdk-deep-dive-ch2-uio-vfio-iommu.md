...
**下一篇预告**：[[2026-04-09-dpdk-deep-dive-ch3-eal-initialization|第三章]]将深入讲解 DPDK EAL 初始化的完整流程，包括 `rte_eal_init` 的每一步做了什么、lcore 如何发现和绑定、master lcore 的角色，以及 EAL 参数的完整解析。
