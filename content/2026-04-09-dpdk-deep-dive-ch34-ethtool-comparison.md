...
> [!info] 关联章节
>
> - [[2026-04-09-dpdk-deep-dive-ch31-debugging-tools|ch31 调试工具——dpdk-devbind、ethtool]]（设备绑定与基础 ethtool）
> - [[2026-04-09-dpdk-deep-dive-ch29-profiling|ch29 性能分析]]（perf / ftrace / bpf）
> - [[2026-04-09-dpdk-deep-dive-ch30-performance-tuning|ch30 性能调优]]（队列、Mbuf、IRQ affinity）
> - [[2026-04-09-dpdk-deep-dive-ch43-tools-debug|ch43 工具与调试]]（全套工具栈汇总）
>
