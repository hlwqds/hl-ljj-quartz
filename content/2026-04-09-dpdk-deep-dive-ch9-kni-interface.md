...
> 5. [[2026-04-09-dpdk-deep-dive-ch5-mbuf-mechanism|第五章：Mbuf 结构、Dynfield]]
...
> 8. [[2026-04-09-dpdk-deep-dive-ch8-timer-wheel|第八章：rte_timer 软件定时器]]
...
**下一篇预告**：[[2026-04-09-dpdk-deep-dive-ch10-flow-classification|第十章]]将深入讲解 DPDK 流量分类——Flow Director、ACL 库、RSS 哈希、以及基于 rte_flow 的通用匹配动作框架。
