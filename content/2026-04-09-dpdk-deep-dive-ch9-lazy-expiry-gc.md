...
> 8. [[2026-04-09-dpdk-deep-dive-ch8-timer-wheel|第八章：rte_timer 软件定时器与 HTimer 实现]]
> 9. **第九章：懒惰过期与 GC 机制**
...
[[2026-04-09-dpdk-deep-dive-ch8-timer-wheel|第八章]]介绍了 `rte_timer` 的时间轮实现，适合几十到几千个定时器的场景。但高性能网关面临的是**百万级 per-flow 定时器**的需求：
