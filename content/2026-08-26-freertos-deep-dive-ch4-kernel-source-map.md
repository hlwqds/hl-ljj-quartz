...
> [!info] FreeRTOS 深度解析系列 0. [[2026-08-26-freertos-deep-dive-series-index|系列索引]] 4. **第四章：源码地图——内核结构、Kconfig 裁剪与编译产物**
...
下一章正式推开工事：`xTaskCreate()` 从参数校验、TCB 分配、栈填充到挂入就绪链表的全流程，以及 TCB 结构体里每个字段存在的原因——任务的生与死，[[2026-08-26-freertos-deep-dive-ch5-task-lifecycle-and-tcb|第五章]]见。
