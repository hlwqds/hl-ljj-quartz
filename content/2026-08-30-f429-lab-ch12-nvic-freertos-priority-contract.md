...
tags: [STM32, FreeRTOS, CortexM, Lab]
---
...
> 工程实值核对。方法论继承[[2026-08-30-stm32f429-brick-rescue-debug-story|序章]]。
...
- 本章是系列「反哺主系列」的一章：与
  [[2026-08-26-freertos-deep-dive-ch18-critical-sections-spinlocks|FreeRTOS（十八）：临界区契约]]
...
[[2026-08-30-f429-lab-ch17-pendsv-single-step|ch17：PendSV 单步]]的戏份。
...
上一章：[[2026-08-30-f429-lab-ch11-adc-dma-double-buffer|ADC+DMA 双缓冲：无 CPU 的采样流]]；
下一章：[[2026-08-30-f429-lab-ch13-ccm-dma-isolation|CCM 实测：DMA 走不进的房间]]。系列总目录见
