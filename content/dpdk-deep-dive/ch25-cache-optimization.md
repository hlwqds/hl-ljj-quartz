...
- [[ch25a-simd-vectorization|第二十五-A章：SIMD 向量化——单核里的数据并行]]
- [[ch25b-prefetch-deep-dive|第二十五-B章：预取技术——把内存等待变成后台工作]]

**下一篇预告**：[[ch26-numa-optimization|第二十六章]]将讲解 NUMA 亲和性优化——local/remote 访问、内存分配策略、多核调度。
