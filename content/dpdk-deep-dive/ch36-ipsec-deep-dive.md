...
> [!info] 章节定位
> 系列中已有 [[ch36-p4-dpdk|第三十六章：P4 可编程数据面]]，
> 因此本文按 **ch36b 专题章**处理。
>
...
> [!info] 关联章节
>
> - [[ch21-cryptodev|cryptodev 与 Crypto PMD]]
> - [[ch22-ipsec-fullflow|IPsec 完整处理流程与 SAD/SPD]]
> - [[ch24-raw-crypto-api|Raw Crypto API]]
> - [[ch30-lookaside-crypto|Lookaside 加速]]
> - [[ch30-performance-tuning|性能调优]]
> - [[ch40-wireguard-dpdk|WireGuard 与 DPDK]]
