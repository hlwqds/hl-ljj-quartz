...
> [!info] 章节定位
> 系列中已有 [[ch39-container-networking|第三十九章：容器网络与 DPDK]]，
> 因此本文按 **ch39b 专题章**处理。
>
> 关联章节：
>
> - [[ch38-firewall-dpdk|防火墙数据面——ACL、Conntrack、NAT 与硬件卸载]]
> - [[ch38-dpdk-ebpf|eBPF/XDP 与 DPDK 协同——AF_XDP PMD]]
...
详细 XDP 内容见 [[ch38-dpdk-ebpf|ch38：eBPF/XDP 与 DPDK 协同]]。
...
- [[ch38-dpdk-ebpf|ch38：eBPF/XDP 与 DPDK 协同]]
