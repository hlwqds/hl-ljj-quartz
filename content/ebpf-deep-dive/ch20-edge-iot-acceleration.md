...
参考[[ch19-atomic-updates-and-hot-upgrade|第十九章]]的原子更新机制，边缘网关可以实现在不中断工业通信的前提下更新 eBPF 程序：
...
- 对 BPF 程序进行签名验证（参考[[ch31-signed-objects-and-security|第三十一章]]）
...
- [[ch5-xdp-networking-performance|第五章 XDP]]：本章的 XDP 加速技术基础
- [[ch6-tc-traffic-control|第六章 TC]]：本章的 TC BPF 协议解析基础
- [[ch19-atomic-updates-and-hot-upgrade|第十九章 热更新]]：边缘网关的蓝绿部署机制
- [[ch31-signed-objects-and-security|第三十一章 签名安全]]：eBPF 程序的供应链安全保障
- [[ch16-ebpf-and-wasm|第十六章 WASM]]：WASM + eBPF 混合架构的边缘计算方案
