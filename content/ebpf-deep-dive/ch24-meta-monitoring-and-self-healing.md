...
> 8. [[ch7-5-uprobes-dynamic-tracing|第七.五章：uprobe 用户态动态追踪]]
...
> [!tip] 下一步
> 下一章 [[ch25-full-stack-observability|第二十五章：全栈可观测性与端到端追踪]] 将在本章元监控的基础上，进一步讲解如何将 BPF 监控数据与分布式追踪、日志系统、指标平台整合，构建完整的全栈可观测性解决方案。
