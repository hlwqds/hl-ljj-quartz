...
> 上一章：[[ch6-boot-to-app-main|第六章：从上电到 app_main]]
> **第七章：系统服务层——日志、NVS、事件循环与 esp_timer**（当前章）
> 下一章：[[ch8-gpio-interrupts|第八章：GPIO 与中断]]
...
[[ch15-software-timers-daemon|FreeRTOS（十五）软件定时器]]拆过 Tmr Svc 守护任务模型，这里只给选型表（数字均已对源码核实）：
