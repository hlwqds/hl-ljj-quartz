...
tags: [f429-lab, STM32, FreeRTOS, Stack]
---
...
> [[ch14-stack-units-word-vs-byte|ch14：栈的单位]]。
...
IDF 的硬件 watchpoint 方案见[[ch21-stack-and-memory-layout|FreeRTOS（廿一）]]21.4），
...
[[ch24-debugging-tracing-pitfalls|FreeRTOS（廿四）]]排坑方法论的第 1 案
...
下一章：[[ch17-pendsv-single-step|PendSV 单步：亲眼看上下文切换]]——
本章冻结在 hook 里的现场，正是下一章 DAP 单步 `xPortPendSVHandler` 的入口素材：R4–R11 怎么压栈、
PSP 怎么换手，一条指令一条指令看。系列总目录见[[f429-lab|F429 裸机实验室索引]]。
