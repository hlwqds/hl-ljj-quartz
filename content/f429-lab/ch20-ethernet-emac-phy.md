...
> RM0090 一致。方法论与工具链继承[[2026-08-30-stm32f429-clock-misconfig-postmortem|故障复盘]]。
...
[[ch17-ethernetif-porting-guide|（十七）：ethernetif 移植指南]]）换真身对号：
...
上一章：[[ch19-heap4-fragmentation|heap_4 碎片实验]]——静态数组堆的结论马上
要在 lwIP 的 pbuf 池上复用；下一章：[[ch21-baremetal-lwip|裸机 lwIP]]——把本章
