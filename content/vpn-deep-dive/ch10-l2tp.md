...
**下一章预告：** [[ch11-openvpn|OpenVPN 基础]] — SSL VPN、TUN/TAP 模式、OpenSSL 加密、easy-rsa 证书、客户端配置。
...
> - RFC 3193 - L2TP/IPSec
> - [[ch9-pptp|PPTP 隧道 (本系列)]] — PPTP 与 L2TP 的历史关系
> - [[ch14-ipsec-overview|IPSec 体系概述 (本系列)]] — L2TP/IPSec 配合
